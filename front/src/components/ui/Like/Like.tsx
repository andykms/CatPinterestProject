...
export const Like = memo((props: LikeProps) => (
  <svg
    ...
    className={clsx(
      styles.like,
      props.isLiked ? styles.liked : styles.notLiked
    )}
    onClick={props.onClick}
  >
    <path
      className={styles.heartInner}
      d="M20 36.7L17.1 34.06C6.8 24.72 0 18.56 0 11C0 4.84 4.84 0 11 0C14.48 0 17.82 1.62 20 4.18C22.18 1.62 25.52 0 29 0C35.16 0 40 4.84 40 11C40 18.56 33.2 24.72 22.9 34.06L20 36.7Z"
      fill="transparent"
    />
    <path
